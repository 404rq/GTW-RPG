...
function colorPicker:render()
  ...
  dxDrawImage(x+16, y+32, 256, 256, "colorpicker/sv.png", 0, 0, 0, self.color.white, true)
  dxDrawImage(x+288, y+32, 32, 256, "colorpicker/h.png", 0, 0, 0, self.color.white, true)
  dxDrawImageSection(x+8+math.floor(256*self.color.s), y+24+(256-math.floor(256*self.color.v)), 16, 16, 0, 0, 16, 16, "colorpicker/cursor.png", 0, 0, 0, self.color.white, true)
  dxDrawImageSection(x+280, y+24+(256-math.floor(256*self.color.h)), 48, 16, 16, 0, 48, 16, "colorpicker/cursor.png", 0, 0, 0, self.color.huecurrent, true)
  dxDrawRectangle(x+336, y+32, 64, 64, self.color.current, true)
  dxDrawText(self.color.hex, x+336, y+32, x+400, y+96, self.color.v < 0.5 and self.color.white or self.color.black, 1, "default", "center", "center", true, true, true)
	if not preHex or preHex ~= self.color.hex then
		preHex = self.color.hex
		triggerEvent("onColorPickerPreChange", root, self.id, self.color.hex, self.color.r, self.color.g, self.color.b)
	end
end
