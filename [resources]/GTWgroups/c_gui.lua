...
function makeGUI()
	...
	rejectInviteButton = guiCreateButton(124, 450, 110, 36, "Reject Invite", false, minePanel)
	acceptInviteButton = guiCreateButton(10, 450, 110, 36, "Accept Invite", false, minePanel)
	...
	addEventHandler("onClientGUIClick", rejectInviteButton, reject_invite, false)
	addEventHandler("onClientGUIClick", acceptInviteButton, accept_invite, false)
