...
addEventHandler("onPlayerLogin", root,
	function (_, acc)
		...
		-- Get position
		local posX = exports.GTWcore:get_account_data(acc, "GTWdata.loc.x")
		local posY = exports.GTWcore:get_account_data(acc, "GTWdata.loc.y")
		local posZ = exports.GTWcore:get_account_data(acc, "GTWdata.loc.z")
		local rotZ = exports.GTWcore:get_account_data(acc, "GTWdata.loc.rot.z")
		...
		-- Get player location x y z
			...
			--local health = exports.GTWcore:get_account_data(playeraccount, "GTWdata.health")
			--local armor = exports.GTWcore:get_account_data(playeraccount, "GTWdata.armor")
...
addEventHandler("onPlayerJoin", root,
	function ()
		...
		s_text[source][2] = textCreateTextItem("#  www.404rq.com | discuss.404rq.com | code.404rq.com | games.404rq.com  #", 0.5, 0.91,1,200,200,200,255,1.4,"center","center",200)
		s_text[source][3] = textCreateTextItem("Please wait while we're downloading the GTW-RPG v4.0 game mode for you...", 0.5, 0.1,1,200,200,200,255,1.4,"center","center",200)
