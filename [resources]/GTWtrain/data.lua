...
Settings = {
	...
	update_sync_time	= 1000,          -- Time between each sync update
	...
	debug_level		= 2,             -- How many debug messages should display in server console
}
...
coords = {
	{1,2,0, -1942,174,27, 10},  -- STATION
        {0,0,0, -1934,238,25, 50},
        {0,2,0, -1920,276,20, 90},
        {0,2,0, -1861,327,9, 90},
        ...
        {0,2,0, -43,1292,19, 100},
        {0,1,0, 90,1283,21, 50},
        {1,2,0, 127,1274,24, 10},  -- STATION
        {0,0,0, 302,1213,24, 50},
        {0,2,0, 477,1219,16, 90},
        {0,2,0, 625,1298,13, 80},
        {0,2,0, 717,1375,13, 80},
        {0,1,0, 741,1492,11, 50},
        {1,2,0, 743,1780,7, 10},  -- STATION
        {0,0,0, 741,1935,7, 50},
        {0,2,0, 740,2054,10, 80},
        ...
        {0,2,0, 1180,2643,13, 70},
        {0,1,0, 1311,2632,12, 30},
        {1,2,0, 1451,2632,12, 10},  -- STATION
        {0,0,0, 1581,2632,12, 30},
        {0,2,0, 1639,2636,12, 50},
        ...
        {0,2,0, 2722,2123,0, 80},
        {0,1,0, 2782,1999,5, 40},
        {1,2,0, 2780,1738,12, 10},  -- STATION
        {0,0,0, 2813,1603,12, 50},
        {0,1,0, 2864,1438,12, 50},
        {1,2,0, 2864,1258,12, 10},  -- STATION
        {0,0,0, 2772,1045,12, 40},
        {0,2,0, 2764,975,12, 60},
        {0,2,0, 2764,888,12, 70},
        {0,2,0, 2764,768,12, 80},
        {0,2,0, 2765,610,11, 80},
        {0,2,0, 2765,392,9, 80},
        {0,2,0, 2765,306,9, 70},
        {0,2,0, 2798,190,15, 70},
        {0,1,0, 2821,101,26, 40},
        {1,2,0, 2827, 32,26, 10},  -- STATION
        {0,0,0, 2827,-94,35, 50},
        {0,2,0, 2794,-192,29, 40},
        {2,2,0, 2755,-262,21, 0},
        {0,1,0, 2615,-295,15, 70},
        {0,1,0, 2479,-277,19, 80},
        {0,1,0, 2373,-279,22, 80},
        ...
        {0,2,0, 2242,-1564,20, 50},
        {0,2,0, 2212,-1641,17, 50},
        {0,2,0, 2199,-1707,15, 50},
        {0,2,0, 2198,-1848,15, 50},
        {0,2,0, 2197,-1909,15, 40},
        {0,2,0, 2173,-1947,15, 40},
        {0,2,0, 2133,-1954,15, 50},
        {0,2,0, 2031,-1954,15, 50},
        {0,2,0, 1950,-1954,15, 50},
        {0,1,0, 1895,-1954,15, 40},
        {1,2,0, 1732,-1958,15, 10},  -- STATION
        {0,0,0, 1674,-1954,15, 50},
        {0,2,0, 1588,-1954,15, 90},
        {0,2,0, 1507,-1954,15, 100},
        {0,2,0, 1366,-1939,9, 110},
        {0,2,0, 1221,-1808,-3, 110},
        {0,2,0, 1124,-1696,-3, 110},
        {0,2,0, 984,-1537,-1, 110},
        {0,2,0, 927,-1476,-1, 100},
        {0,1,0, 872,-1421,0, 50},
        {1,2,0, 790, -1345,-1, 10},  -- STATION
        {0,0,0, 763,-1321,0, 50},
        {0,2,0, 694,-1265,2, 100},
        {0,2,0, 612,-1204,5, 110},
        ...
        {0,2,0, -961,-1498,89, 110},
        {0,2,0, -1073,-1507,67, 80},
        {0,1,0, -1166,-1518,44, 50},
        {1,2,0, -1295,-1511,28, 10},  -- STATION
        {0,0,0, -1396,-1510,24, 60},
        {0,2,0, -1506,-1504,20, 140},
        {0,2,0, -1649,-1477,15, 150},
